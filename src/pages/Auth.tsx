...
import { ShoppingBag, Store, Package, ArrowLeft } from "lucide-react";
...
const Auth = () => {
  ...
  const [role, setRole] = useState<"customer" | "retailer" | "wholesaler">("customer");
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Show the actual error message without auto-switching to signup
      toast({
